...
from can_setup import setup_can

class controller_omni(Node):
    def __init__(self):
    ...
    def read_thread_function(self):
        while True:
            self.can_setup.send_data_can(self.motor_vel)
            a = self.can_setup.read_position_data_can()
            print(str(a))
...
def main(args=None):
    ...
    drive_controller = controller_omni()
    try:
